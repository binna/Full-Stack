...
public class Switch03Main {
	...
	public static void main(String[] args) {
		...
		long num = 1;
		//switch(num) {}	// 에러
							// Cannot switch on a value of type long. Only convertible int values, string or enum variables are permitted
		float real = 1;
		//switch(real) {}	// 에러
		// Cannot switch on a value of type float. Only convertible int values, string or enum variables are permitted
